...
export const courses: CourseData[] = [
    // ─── Web Development ──────────────────────────────────────────────────────
    {
        ...
        curriculum: [
            ...
            { title: "JavaScript Basics", lectures: 6, duration: "22m", lessons: ["Buy course to access all lessons"] },
            { title: "DOM Manipulation", lectures: 4, duration: "15m", lessons: ["Buy course to access all lessons"] },
            { title: "APIs & Async JavaScript", lectures: 5, duration: "20m", lessons: ["Buy course to access all lessons"] },
            { title: "Version Control with Git", lectures: 3, duration: "10m", lessons: ["Buy course to access all lessons"] },
            { title: "Deployment", lectures: 3, duration: "10m", lessons: ["Buy course to access all lessons"] },
        ],
        faqs: [
    ...
    // ─── UI/UX Design ─────────────────────────────────────────────────────────
    {
        ...
        curriculum: [
            ...
            { title: "Wireframing & Information Architecture", lectures: 4, duration: "15m", lessons: ["Buy course to access all lessons"] },
            { title: "UI Design Fundamentals", lectures: 6, duration: "24m", lessons: ["Buy course to access all lessons"] },
            { title: "Figma from Scratch", lectures: 8, duration: "35m", lessons: ["Buy course to access all lessons"] },
            { title: "Prototyping & Usability Testing", lectures: 5, duration: "20m", lessons: ["Buy course to access all lessons"] },
            { title: "Portfolio & Career Prep", lectures: 4, duration: "16m", lessons: ["Buy course to access all lessons"] },
        ],
        faqs: [
    ...
    // ─── Data Analytics ───────────────────────────────────────────────────────
    {
        ...
        curriculum: [
            ...
            { title: "SQL Fundamentals", lectures: 6, duration: "24m", lessons: ["Buy course to access all lessons"] },
            { title: "Python for Data Analytics", lectures: 8, duration: "32m", lessons: ["Buy course to access all lessons"] },
            { title: "Data Visualisation with Power BI", lectures: 6, duration: "25m", lessons: ["Buy course to access all lessons"] },
            { title: "Statistics for Analysts", lectures: 5, duration: "20m", lessons: ["Buy course to access all lessons"] },
            { title: "Capstone Projects & Portfolio", lectures: 4, duration: "18m", lessons: ["Buy course to access all lessons"] },
        ],
        faqs: [
