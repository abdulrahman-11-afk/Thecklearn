...
export default function About() {
    return (
        <section id="About" className="scroll-mt-20 pt-16 px-4 md:px-14">
            ...
            <div className="flex flex-col md:flex-row items-center pt-10 md:pt-14 gap-10 md:justify-between">
                <div className="w-full md:w-auto flex justify-center">
                    <Image
                        ...
                        width={300}
                        height={200}
                        className="w-full max-w-[480px] md:w-[620px] min-h-[300px] md:min-h-[500px] object-cover rounded-xl"
                    />
                </div>
