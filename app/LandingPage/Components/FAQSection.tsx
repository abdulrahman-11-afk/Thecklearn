...
export default function Faq() {
    ...
    return (
        <div id="faq" className="scroll-mt-12 pt-16 px-4 md:px-12 lg:px-32 xl:px-48">
            <div className="flex flex-col items-center text-center gap-y-4">
                ...
                <p className="text-[#6F6A6A] text-[13px] md:text-[15px]">
                    From how courses work to what's included — here are answers to the most
                    common questions about learning with Thecklearn.
                </p>
            </div>
            <div className="flex flex-col gap-6 mt-12">
                {faqs.map((faq, index) => (
                    <div key={index} className=" pb-4">
                        ...
                        >
                            <p className="text-[14px] md:text-[16px] pr-2">{faq.q}</p>
                            <p className="text-[24px] md:text-[29px] text-[#566273] flex-shrink-0">
                                {openIndex === index ? "−" : "+"}
                            </p>
                        </div>
                        {openIndex === index && (
                            <p className="mt-3 text-[13px] md:text-[15px] text-gray-500 leading-relaxed">
                                {faq.a}
                            </p>
                        )}
                    </div>
